    ...
    return (
        <View style={[styles.container, { backgroundColor: "#000" }]}>
            <View style={styles.header}>
                ...
                <ThemedText style={styles.title}>Chụp mặt trước CMND/CCCD</ThemedText>
                <View style={{ width: 28 }} />
            </View>

            <View style={styles.cameraPlaceholder}>
                <View style={styles.guideFrame} />
                <ThemedText style={styles.guideText}>Đặt mặt trước thẻ vào khung hình</ThemedText>
            </View>

            <View style={styles.controls}>
                <TouchableOpacity style={styles.shutter} onPress={() => router.push("/id-camera-back")} />
            </View>
        </View>
    );
}
