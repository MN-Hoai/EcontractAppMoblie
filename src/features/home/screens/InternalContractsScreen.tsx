...
const ALL_CONTRACTS = [
    ...
    { id: "5", title: "Tờ trình phê duyệt ngân sách Q1", status: "Chờ duyệt", sender: "Thu Hà", date: "05/01/2025 08:00", type: "waiting" },
    { id: "6", title: "Hợp đồng thuê văn phòng", status: "Hoàn thành", sender: "Minh Tuấn", date: "04/01/2025 11:30", type: "completed" },
];
...
export default function InternalContractsScreen() {
            ...
            >
                <View style={styles.cardMainRow}>
                    <View style={[styles.iconContainer, { backgroundColor: isDark ? "#2C5364" : "#E3F2FD" }]}>
                        <MaterialCommunityIcons name="office-building-outline" size={24} color="#2196F3" />
                    </View>
            ...
            >
                <View style={styles.headerTop}>
                    ...
                    <View style={styles.headerTitleBlock}>
                        <ThemedText style={styles.headerTitle}>Trình ký nội bộ</ThemedText>
