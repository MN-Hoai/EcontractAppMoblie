...
export default function IDCameraFrontScreen() {
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      // Store the photo or proceed to next step
      setTimeout(() => {
        setIsCapturing(false);
        router.push({
          pathname: "/id-camera-back",
          params: { photoFront: photo.uri },
        });
      }, 500);
    } catch {
      setIsCapturing(false);
  ...
  const handleRetry = () => {
    Alert.alert("Thử lại", "Vui lòng chụp lại mặt trước CCCD");
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.controlsContainer}>
        <View style={styles.guidanceBox}>
          <ThemedText style={styles.guidanceTitle}>Hướng dẫn:</ThemedText>
